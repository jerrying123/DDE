...
if __name__ =="__main__":
	...
	n_c = 7
	N_states = 2
	datasizes = [1000,1500,2500,5000,10000,25000]#[500,800,1000,1500,2500,5000,10000,25000]
	for dsize in datasizes:
		...
		# print(inter)
		base_str = './models/ridge' + str(n_c) +'_' + str(dsize)+ '.csv'
		np.savetxt(base_str, A, delimiter=",")
